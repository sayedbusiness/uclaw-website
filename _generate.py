...
.skip:focus{left:0}
.wrap{max-width:66rem;margin-inline:auto;padding-inline:clamp(1.25rem,4.5vw,2.5rem)}
...
.phero .lede{font-size:1.2rem;max-width:40rem;color:var(--body-d);margin-bottom:1.7rem;position:relative}
...
.prose h2{font-size:clamp(1.7rem,3.4vw,2.4rem);margin-bottom:1rem;max-width:40rem}
.prose h3{font-size:1.3rem;margin:1.8rem 0 .6rem}
.prose p{font-size:1.08rem;margin-bottom:1.1rem;max-width:44rem}
